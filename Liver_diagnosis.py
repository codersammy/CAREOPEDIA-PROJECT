...
##mydb=mysql.connector.connect(host="localhost",user="root",passwd="abc123*",database="careopedia")
...
class liver(Tk):
    def __init__(self):
        def detection():
            ...
            X = liver_data.drop(columns=['status'], axis=1)
            Y = liver_data['status']
            ...
            try:
                input_data = (e1, e2, e3, e4, e5, e6, e7, e8, e9, e10, e11)
...
##        Radiobutton(root,text="Other",padx= 20, variable= var, value=3, bg='pink', font=("arial",10, "italic", "bold")).place(x=690,y=230)
        ...
        label_9.place(x=150,y=580)

        entry_9=Entry(root, width= 25, bd=5)
        entry_9.place(x=500,y=580)

        label_10=Label(root,text="Albumin_and_Globulin_Ratio",width=25, bg='pink',font=('arial',12, "italic", "bold"))
        label_10.place(x=150,y=630)

        entry_10=Entry(root, width= 25, bd=5)
        entry_10.place(x=500,y=630)

        label_11=Label(root,text="MR No.",width=25, bg='pink',font=('arial',12, "italic", "bold"))
        label_11.place(x=150,y=680)

        entry_11=Entry(root, width= 25, bd=5)
        entry_11.place(x=500,y=680)

        #this creates button for submitting the details provides by the user
        Button(root, text='SUBMIT' , width=20,bg="red",fg='white',font=('arial',12, "italic", "bold"), bd=14,command=detection).place(x=240,y=720)
